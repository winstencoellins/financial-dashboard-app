...
export default function Sidebar () {
    ...
    return (
        <aside className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-black border-r rtl:border-r-0 rtl:border-l">
            <p className="mx-4 text-white">Menu</p>

            <hr className="mt-8 border-gray-200 dark:border-gray-600" />
